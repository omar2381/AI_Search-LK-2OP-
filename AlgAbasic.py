...
############ WHICH IS YOUR USER-NAME, E.G., 'abcdistB2', WHICH IN TURN SITS IN ANOTHER
...
############ THE FOLDER 'city-files' AND THE FOLDER WHOSE NAME IS YOUR USER-NAME, E.G., 'abcdistB2'.
############
...
############
############ THE RESERVED STRING VARIABLE 'my_user_name' SHOULD BE SET AT YOUR USER-NAME, E.G., "abcdistB2"
############

my_user_name = "zsddistC5"
    ...
    while done == False:
        ...
        while i < len(dist_matrix) and time.process_time()-start < 57:
            ...
            while j < len(dist_matrix):         
                two_dist,two_route = two_opt(tour,i,j)
                three_route,three_dist = three_opt(tour,i,j)
                if two_dist < three_dist:
                    dist = two_dist
                    new_route = two_route
                else:
                    dist = three_dist
                    new_route = three_route
                if dist < shortest:
                    done = False
                    tour = new_route
                    shortest = dist
